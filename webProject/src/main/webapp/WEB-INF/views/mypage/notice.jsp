...
<div class="contents">
    	<div id="mainWrapper">
          ...
          <div name="uid" hidden></div>
            <!-- 게시판 제목 -->
            <h2 style="text-align:center; margin-bottom:10px;">공지사항</h2>
	                ...
	                <c:forEach var="notice" items="${noticeList}" >          
	                        <li>
	                            <ul class="nw">
	                                ...
	                                <li class="left"><a href="${contextPath}/mypage/noticeView.do?noticeNO=${notice.noticeNO}">${notice.title}</a></li>
...
<script>
	...
	let moveForm = $("#moveForm");
		...
		moveForm.attr("action", "/mypage/notice.do");
		moveForm.submit();
