	    ...
	    <div class="contents_area">
	        ...
	        <div class="contents">    
                ...
                <ul>
	                ...
	                <div id="search">
		            	<form method="post" action="${contextPath}/page/goodsFilterPage1.do">
		                    <div class="destination">
		                        <p>여행지, 상품명</p>
		                        <input type="text" name="goodsSubCategory" id="goodsSubCategory" placeholder="여행지 또는 상품명을 입력해주세요." />
		                    </div>
	                			...
	                			<form id="goodsInfo${Hotitem.uid}" method="post">
	                				<div class="product_item">
	                					...
	                					<div class="txt_wrap">
	            							...
	            							<div class="score">${HotgoodsList[status.index].score}/5점</div>
		            			...
		            			<form id="goodsInfo${item.uid}" method="post">
		            				<div class="product_item">
		            					...
		            					<div class="txt_wrap">
		        							...
		        							<div class="score">${goodsList[status.index].score}/5점</div>
		        							<div class="goods_price">
