...
<head>
    ...
    <script type="text/javascript">
	    ...
	    function cart(frmobj1, n) {
	    	var num = $('#numOfTourist').val(); //티켓 인원 수
...
<div class="contents_area">
	...
	<div class="indexBar">
	    <div class="indexButton">
	    	<a href="#rooms_info">티켓요금/선택</a>
	    </div>
	    <div class="indexButton">
	        <a href="#hotelNearInfo">주변 정보</a>
	    </div>
	    <div class="indexButton">
	        <a href="#hotelInfo">투어&티켓 정보</a>
	    </div>
	    <div class="indexButton">
	        <a href="#review">후기</a>
	    </div>
	    ...
	    <div class="default_option">
	        ...
	        <div class="day">
	        	<div>
	        		<input type="date" id="startDate" name="cartcheckin" placeholder="출발 날짜"/>
	        	</div>
		...
		<c:if test="${not empty goods && goods != 'null' }">
			<c:forEach var="item" items="${goods}" varStatus="status">
	            <form name="lodgingInfoFrm" method="post" submit="return false;">
	                ...
	                <div class="rooms">
	                    ...
	                    <div class="room_info_wrap">
	                        ...
	                        <div class="room_name">${item.goodsName}
                        	...
                        	<div class="room_detail_button">
                            	<button type="button" id="modal_opne_btn${item.goodsId}">상품상세정보</button>
	                        </div>
	                    </div>
	                    <div class="room_wrap">
	                        <div class="room_price">
	                            <b>남은 티켓 : ${item.goodsCount}</b>
	                        </div>
	                    </div>
	                    <div class="room_wrap">
	                        <div class="room_price">
	            ...
	            <div class="modal_content">
		            ...
		            <div class="modal_detail_goodsName">${item.goodsName} / 1인</div>	
		            ...
		            <div class="modal_detail_div_3">		        
		            	가이드 ${goodsDetail[status.index].guide}
		            </div>
		            </div>
		            </div>
