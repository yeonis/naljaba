...
<link type="text/css" rel="stylesheet" href="/css/userList.css" />
	    ...
	    <div class="contents">
	        ...
	        <div class="paging">
	        	<div class="search_wrap">
		            <form action="${contextPath }/admin/findUserList.do" method="post" class="usernameform">
	            ...
	            <c:choose>
	                ...
	                <c:otherwise>
	                    <button id="userListpage_button1">
	                        <a href="${contextPath}/admin/userList.do"
...
moveForm.attr("action", "/admin/userList.do");
moveForm.submit();
