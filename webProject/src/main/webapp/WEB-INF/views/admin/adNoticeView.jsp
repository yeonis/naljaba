	...
	<div class="contents_area">
		<div class="soon">
			...
			<div>
				...
				<div class="contents">
				<form name="frmNotice" method="post" action="${contextPath}/admin/modNotice"
							...
							<td colspan="2" align="center"><c:choose>
									<c:when test="${member.userType==0}">
										<button type="submit" id="button">
											<a href="/admin/modNotice.do?noticeNO=${viewNotice.noticeNO}">수정하기</a>
										</button>
										<input type="button" value="삭제하기"
											onclick="fn_removeNotice('${contextPath}/admin/noticeRemove.do', ${viewNotice.noticeNO})">
									</c:when>
								</c:choose> 
								
								<input type="button" value="리스트로" 	onclick="backToList(frmNotice)"></td>
						</tr>
					</table>
				</form>
			</div>
