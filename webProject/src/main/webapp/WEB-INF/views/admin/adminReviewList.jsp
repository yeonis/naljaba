...
<c:set var="adminReviewList" value="${adminReviewList}"/>
...
<script type="text/javascript">	
    	function removeReview(uid) {
			...
			var form = document.createElement("form");
				...
				form.setAttribute("action", "${contextPath}/admin/adminReviewDelete.do");
		...
		<div class="soon">
			...
			<div>
				...
				<div class="contents">
					...
					<div id="review_info">
						<c:if test="${not empty adminReviewList && adminReviewList != 'null' }">
									...
									<div class="rooms">
										...
										<div class="room_wrap">
											<div class="room_price">
												<b> ${item.goodsId}</b><br> <b>리뷰 점수: ${item.score}</b>
										...
										<div class="room_wrap">
											<div class="goods_button_wrap">
												<input type="button" class="admin_btn"
													onclick="removeReview('${item.uid}')" value="리뷰 삭제" />
											</div>
					...
					<div class="paging">
						<div class="search_wrap">
							<form action="/admin/adminReviewListSearch.do" method="post">
					...
					<c:choose>
						...
						<c:otherwise>
							<button id="userListpage_button1">
								<a href="${contextPath}/admin/adminReviewList.do"
...
moveForm.attr("action", "/admin/adminReviewList.do");
moveForm.submit();
